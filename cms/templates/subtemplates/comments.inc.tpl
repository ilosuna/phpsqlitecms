...
<?php if($pagination['previous']): ?><li><a href="<?php echo BASE_URL . PAGE; if($pagination['previous']>1): ?>,<?php echo $pagination['previous']; endif; ?>#comments">&laquo;</a></li><?php endif; ?>
...
<?php endforeach; ?>
<?php if($pagination['next']): ?><li><a href="<?php echo BASE_URL . PAGE; ?>,<?php echo $pagination['next']; ?>#comments">&raquo;</a></li><?php endif; ?>
</ul>
<?php endif; ?>
