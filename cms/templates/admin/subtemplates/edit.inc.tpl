...
<label for="page" class="col-lg-1 control-label control-label-left"><?php echo $lang['edit_page_name_marking']; ?></label>
<div class="col-lg-11">
<div class="input-group">
<span class="input-group-addon"><?php echo BASE_URL; ?></span>
<input id="page" type="text" name="page" value="<?php if(isset($page_data['page'])) echo $page_data['page']; ?>" size="50" class="form-control" />
</div>
</div>
</div>

<div class="form-group">
<label for="title" class="col-lg-1 control-label control-label-left"><?php echo $lang['edit_title_marking']; ?></label>
<div class="col-lg-11">
<input id="title" type="text" name="title" value="<?php if(isset($page_data['title'])) echo $page_data['title']; ?>" size="50" class="form-control" />
</div>
</div>
...
<textarea id="sidebar_1" name="sidebar_1" cols="70" rows="13" class="form-control html"><?php if(isset($page_data['sidebar_1'])) echo $page_data['sidebar_1']; ?></textarea>
</div>
</div>
<!--<div class="checkbox">
...
<input type="text" name="type_addition" value="<?php if(isset($page_data['type_addition'])) echo $page_data['type_addition']; ?>" placeholder="<?php echo $lang['edit_type_addition_marking']; ?>" size="40" class="form-control form-control-inline form-control-medium" />
</div>
</div>
...
<div class="col-lg-10">
<input id="time" type="text" name="time" value="<?php if(isset($page_data['time'])) echo $page_data['time']; ?>" placeholder="<?php echo $lang['edit_time_format']; ?>" size="20" class="form-control form-control-inline form-control-default" />
</div>
</div>

<div class="form-group">
<label for="last_modified" class="col-lg-2 control-label"><?php echo $lang['edit_last_modified_marking']; ?></label>
<div class="col-lg-10">
<input id="last_modified" type="text" name="last_modified" value="<?php if(isset($page_data['last_modified'])) echo $page_data['last_modified']; ?>" placeholder="<?php echo $lang['edit_time_format']; ?>" size="20" class="form-control form-control-inline form-control-default" />


<div class="checkbox">
<label for="display_time">
<input type="checkbox" id="display_time" name="display_time" value="1"<?php if(isset($page_data['display_time'])&&$page_data['display_time']==1): ?> checked="checked"<?php endif; ?> /> <?php echo $lang['edit_display_time_label']; ?>
</label>
</div>
</div>
</div>
...
<div class="col-lg-10">
<input id="sections" type="text" name="sections" value="<?php if(isset($page_data['sections'])) echo $page_data['sections']; ?>" placeholder="<?php echo $lang['values_comma_separated']; ?>" size="40" class="form-control form-control-inline form-control-default" />
</div>
</div>
...
<div class="col-lg-10">
<input id="description" type="text" name="description" value="<?php if(isset($page_data['description'])) echo $page_data['description']; ?>" size="60" class="form-control form-control-large" />
</div>
</div>
...
<div class="col-lg-10">
<input id="page_info" type="text" name="page_info" value="<?php if(isset($page_data['page_info'])) echo $page_data['page_info']; ?>" size="60" class="form-control form-control-default" />
</div>
</div>
...
<div class="col-lg-10">
      <select id="gcb_1" name="gcb_1" size="1" class="form-control form-control-inline form-control-medium">
       ...
       <option value="<?php echo $gcb['identifier']; ?>"<?php if(isset($page_data['gcb_1']) && $page_data['gcb_1']==$gcb['identifier']): ?> selected<?php endif; ?>><?php echo $gcb['identifier']; ?></option>
       <?php endforeach ?>
       <?php endif; ?>
      </select>
      <select name="gcb_2" size="1" class="form-control form-control-inline form-control-medium">
       ...
       <?php if(isset($gcbs)): ?>
       <?php foreach($gcbs as $gcb): ?>
       <option value="<?php echo $gcb['identifier']; ?>"<?php if(isset($page_data['gcb_2']) && $page_data['gcb_2']==$gcb['identifier']): ?> selected<?php endif; ?>><?php echo $gcb['identifier']; ?></option>
       <?php endforeach ?>
       <?php endif; ?>
      </select>
      <select name="gcb_3" size="1" class="form-control form-control-inline form-control-medium">
       ...
       <option value="<?php echo $gcb['identifier']; ?>"<?php if(isset($page_data['gcb_3']) && $page_data['gcb_3']==$gcb['identifier']): ?> selected<?php endif; ?>><?php echo $gcb['identifier']; ?></option>
...
<div class="col-lg-10">
      <select id="language" name="language" size="1" class="form-control form-control-default">
       <option value=""<?php if(empty($page_data['language'])): ?> selected="selected"<?php endif; ?>><?php echo $lang['page_language_default']; ?></option>
       <?php if(isset($page_languages)): foreach($page_languages as $page_language): ?>
       <option value="<?php echo $page_language['identifier']; ?>"<?php if(isset($page_data['language']) && $page_data['language']==$page_language['identifier']): ?> selected="selected"<?php endif; ?>> <?php echo $page_language['name']; ?></option>
       <?php endforeach; endif; ?>
      </select>
</div>
</div>
...
<div class="col-lg-10">
<input id="content_type" type="text" name="content_type" value="<?php if(isset($page_data['content_type'])) echo $page_data['content_type']; ?>" placeholder="<?php echo $lang['page_content_type_exp']; ?>" size="20" class="form-control form-control-default" />
</div>
</div>
...
<div class="col-lg-10">
<input type="text" id="tv" name="tv" value="<?php if(isset($page_data['tv'])) echo $page_data['tv']; ?>" placeholder="<?php echo $lang['values_comma_separated']; ?>" class="form-control form-control-default" size="40" />
</div>
</div>
...
<div class="col-lg-10">
<input type="text" id="edit_permission" name="edit_permission" value="<?php if(isset($page_data['edit_permission'])) echo $page_data['edit_permission']; ?>" placeholder="<?php echo $lang['values_comma_separated']; ?>" class="form-control form-control-default" size="40" />
<div class="checkbox">
<label for="edit_permission_general">
<input id="edit_permission_general" type="checkbox" name="edit_permission_general" value="1"<?php if(isset($page_data['edit_permission_general']) && $page_data['edit_permission_general']==1): ?> checked="checked"<?php endif; ?> /> <?php echo $lang['edit_permission_general']; ?>
</label>
</div>
</div>
</div>
...
<div class="form-group">
<label for="include_page" class="col-lg-2 control-label"><?php echo $lang['edit_include_in_marking']; ?></label>
<div class="col-lg-10">
<select id="include_page" name="include_page" size="1" class="form-control form-control-inline form-control-medium">
...
<div class="form-group">
<label for="include_order" class="col-lg-2 control-label"><?php echo $lang['edit_order_number_marking']; ?></label>
<div class="col-lg-9">
<input type="text" id="include_order" name="include_order" value="<?php echo $page_data['include_order']; ?>" size="35" class="form-control form-control-small">
</div>
</div>

<div class="form-group">
<label for="teaser_headline" class="col-lg-2 control-label"><?php echo $lang['edit_teaser_headline_marking']; ?></label>
<div class="col-lg-9">
<input type="text" id="teaser_headline" name="teaser_headline" value="<?php if(isset($page_data['teaser_headline'])): ?><?php echo $page_data['teaser_headline']; ?><?php endif; ?>" size="35" class="form-control">
</div>
</div>
...
<div class="col-lg-9">
<input type="text" id="link_name" name="link_name" value="<?php if(isset($page_data['link_name'])) echo $page_data['link_name']; ?>" size="35" class="form-control">
</div>
</div>

<div class="form-group">
<label for="teaser_img" class="col-lg-2 control-label"><?php echo $lang['edit_teaser_img_marking']; ?></label>
<div class="col-lg-9">
<div class="input-group">
...
<textarea id="page_notes" name="page_notes" cols="70" rows="20" class="form-control"><?php if(isset($page_data['page_notes'])) echo $page_data['page_notes']; ?></textarea>
</div>
</div>
...
<input id="edit_mode_0" type="radio" name="edit_mode" value="0"<?php if(isset($edit_mode) && $edit_mode==0): ?> checked="checked"<?php endif; ?> /> <?php echo $lang['edit_page_mode_edit']; ?>
</label><br />
