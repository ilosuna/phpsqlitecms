...
<div class="col-md-1">
<a class="btn btn-danger btn-xs" href="index.php?mode=settings&amp;delete=<?php echo $key; ?>" title="<?php echo $lang['delete']; ?>" data-delete-confirm="<?php echo rawurlencode($lang['delete_setting_confirm']); ?>"><span class="glyphicon glyphicon-remove"></span></a>
</div>
...
<input type="text" class="form-control" id="name" name="name" placeholder="<?php echo $lang['settings_name']; ?>">
</div>
<div class="form-group">
<label class="sr-only" for="value"><?php echo $lang['settings_value']; ?></label>
<input type="text" class="form-control" id="value" name="value" placeholder="<?php echo $lang['settings_value']; ?>">
</div>
