...
<input class="form-control" id="new_note_section" type="text" name="new_note_section" value="<?php if(isset($new_note_section)) echo stripslashes($new_note_section); ?>" size="25" />
